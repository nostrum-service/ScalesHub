...
namespace Nostrum.ScalesComponent.Serial
{
    ...
    public class SerialPortSettings : BaseChannelSettings
    {
    ...
    public class TcpChannelSettings : BaseChannelSettings
    {
    ...
    /// </summary>
    internal class SerialSettings : INotifyPropertyChanged
    {
        ...
        {
            return String.Format("Port:{0}; Baud rate:{1}; Parity:{2}; Data bits:{3}; Stop bits:{4}", PortName, BaudRate, Parity, DataBits, StopBits);
        }
